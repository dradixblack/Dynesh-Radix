...
public class MP3PlayerGUI extends javax.swing.JDialog 
{
    ...
    private void initComponents() {
        ...
        Background.setIcon(new javax.swing.ImageIcon(getClass().getResource("/uts2/Background.png"))); // NOI18N
    ...
    private void PlayMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_PlayMouseReleased
        ...
        } catch (JavaLayerException | IOException | UnsupportedAudioFileException | LineUnavailableException ex) {
    ...
    private void SelectFileMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_SelectFileMouseReleased
        // TODO add your handling code here:
        FileFilter filter = new FileNameExtensionFilter("MP3 Files", "WAV Files");
